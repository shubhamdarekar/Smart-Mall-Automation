...
def adminDash(request):
    with connection.cursor() as cursor:
        cursor.execute(
            "SELECT id,OrderQuantity,OrderPrice,BuyerID_id,ProductID_id,SellerID_id,SellerStockID_id from SmartMall_order")
        res = cursor.fetchall()
...
def buyerDash(request):
    ...
    with connection.cursor() as cursor4:
        cursor4.execute(
            "SELECT  A.id,A.ProductPrice, A.ProductName  from SmartMall_product as A inner join (Select min(ProductPrice) as min from SmartMall_product) as B on A.ProductPrice=B.min")
    ...
    with connection.cursor() as cursor7:
        cursor7.execute(
            "SELECT  A.id,A.ProductPrice, A.ProductName  from SmartMall_product as A inner join (Select max(ProductPrice) as max from SmartMall_product) as B on A.ProductPrice=B.max")
    ...
    with connection.cursor() as cursor3:
        cursor3.execute(
            "SELECT SmartMall_fridge.id,SmartMall_fridge.FridgeQuantity,SmartMall_fridge.RequiredLimit,SmartMall_product.ProductName from SmartMall_fridge inner join SmartMall_product on SmartMall_fridge.ProductID_id=SmartMall_product.id Where BuyerID_id=(Select id from SmartMall_buyer where UserID_id=%s)" % (
                User_id))
    ...
    with connection.cursor() as cursor5:
        cursor5.execute(
            "SELECT SmartMall_order.id,SmartMall_order.OrderQuantity,SmartMall_order.OrderPrice,SmartMall_order.BuyerID_id,SmartMall_product.ProductName,SmartMall_order.SellerID_id,SmartMall_order.SellerStockID_id from SmartMall_order inner join SmartMall_product on SmartMall_order.ProductID_id=SmartMall_product.id Where SmartMall_order.BuyerID_id=(SELECT id from SmartMall_buyer Where UserID_id=%s)" % (
                User_id))
    ...
    with connection.cursor() as cursor9:
        cursor9.execute(
            "SELECT SmartMall_order.OrderQuantity,SmartMall_order.OrderPrice,SmartMall_product.ProductName from SmartMall_order inner join SmartMall_product on SmartMall_order.ProductID_id=SmartMall_product.id  inner join (Select max(OrderPrice) as maximum from SmartMall_order) as B on SmartMall_order.OrderPrice=B.maximum Where SmartMall_order.BuyerID_id=(SELECT id from SmartMall_buyer Where UserID_id=%s)" % (
                User_id))
    ...
    with connection.cursor() as cursor10:
        cursor10.execute(
            "SELECT SmartMall_order.OrderQuantity,SmartMall_order.OrderPrice,SmartMall_product.ProductName from SmartMall_order inner join SmartMall_product on SmartMall_order.ProductID_id=SmartMall_product.id  inner join (Select min(OrderPrice) as min from SmartMall_order) as B on SmartMall_order.OrderPrice=B.min ")
    ...
    with connection.cursor() as cursor11:
        cursor11.execute(
            "SELECT SmartMall_order.OrderQuantity,SmartMall_order.OrderPrice,SmartMall_product.ProductName from SmartMall_order inner join SmartMall_product on SmartMall_order.ProductID_id=SmartMall_product.id  inner join (Select max(OrderPrice) as min from SmartMall_order) as B on SmartMall_order.OrderPrice=B.min ")
    ...
    with connection.cursor() as cursor12:
        cursor12.execute(
            "SELECT MAX(pp),ww FROM (SELECT sum(SmartMall_order.OrderQuantity) as pp, SmartMall_product.ProductName as ww FROM SmartMall_order inner join SmartMall_product on SmartMall_order.ProductID_id=SmartMall_product.id GROUP BY SmartMall_product.ProductName) AS A ")
    ...
    with connection.cursor() as cursor13:
        cursor13.execute(
            "SELECT pp,ww FROM (SELECT sum(SmartMall_order.OrderQuantity) as pp, SmartMall_product.ProductName as ww FROM SmartMall_order inner join SmartMall_product on SmartMall_order.ProductID_id=SmartMall_product.id GROUP BY SmartMall_product.ProductName) AS A ")
...
def sellerDash(request):
    ...
    with connection.cursor() as cursor:
        cursor.execute(
            "SELECT SmartMall_order.id,SmartMall_order.OrderQuantity,SmartMall_order.OrderPrice,SmartMall_order.BuyerID_id,SmartMall_product.ProductName,SmartMall_order.SellerID_id,SmartMall_order.SellerStockID_id from SmartMall_order inner join SmartMall_product on SmartMall_order.ProductID_id=SmartMall_product.id Where SellerID_id=(SELECT id from SmartMall_seller Where UserID_id=%s)" % (
                User_id))
        res = cursor.fetchall()
        # return HttpResponse(res)
        x = 0
    ...
    with connection.cursor() as cursor7:
        cursor7.execute(
            "SELECT SmartMall_order.OrderQuantity,SmartMall_order.OrderPrice,SmartMall_product.ProductName from SmartMall_order inner join SmartMall_product on SmartMall_order.ProductID_id=SmartMall_product.id  inner join (Select max(OrderPrice) as min from SmartMall_order) as B on SmartMall_order.OrderPrice=B.min Where SmartMall_order.SellerID_id=(SELECT id from SmartMall_seller Where UserID_id=%s)" % (
                User_id))
        res7 = cursor7.fetchall()
        # return HttpResponse(res)
        a = 0
        ...
        for r in res7:
            ...
            a += 1
    return render(request, "SmartMall/seller.html",
                  {"data": data, "data1": data1, "data2": data2, "data3": data3, "data6": data6, "data10": data10,
                   "data11": data11, "data7": data7})
...
def selectsel(request):
    ...
    with connection.cursor() as cursor1:
        cursor1.execute(
            "SELECT SmartMall_order.id,SmartMall_order.OrderQuantity,SmartMall_order.OrderPrice,SmartMall_order.BuyerID_id,SmartMall_product.ProductName,SmartMall_order.SellerID_id,SmartMall_order.SellerStockID_id from SmartMall_order inner join SmartMall_product on SmartMall_order.ProductID_id=SmartMall_product.id Where SellerID_id=%s" % (
                SelID))
        res1 = cursor1.fetchall()
...
def selectbuy(request):
    ...
    with connection.cursor() as cursor2:
        cursor2.execute(
            "SELECT SmartMall_order.id,SmartMall_order.OrderQuantity,SmartMall_order.OrderPrice,SmartMall_order.BuyerID_id,SmartMall_product.ProductName,SmartMall_order.SellerID_id,SmartMall_order.SellerStockID_id from SmartMall_order inner join SmartMall_product on SmartMall_order.ProductID_id=SmartMall_product.id Where BuyerID_id=%s" % (
                BuyID))
        res2 = cursor2.fetchall()
